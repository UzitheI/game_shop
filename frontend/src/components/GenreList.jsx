  ...
  return (
    <div>
        ...
        {genreList.map((item,index)=>(
            <div onClick={()=>setActiveIndex(index)} className={`flex gap-2 items-center mb-2 cursor-pointer hover:bg-gray-500 font-bold group rounded-lg} ${activeIndex===index?'bg-gray-300 text-black rounded-lg ':null}`}>
